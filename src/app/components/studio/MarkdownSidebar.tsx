...
import { Box, List, ListItemButton, ListItemText, Divider, IconButton } from '@mui/material';
...
const MarkdownSidebar: React.FC<SidebarProps> = ({
    ...
    return (
        ...
        <Box
            ...
            style={{ zIndex: 1300 }}
        >
            <IconButton className="absolute top-2 right-2 text-[#6667AB]" onClick={toggleSidebar}>
            <CloseIcon />
            </IconButton>
            <Box mt={4} />
            <List>
